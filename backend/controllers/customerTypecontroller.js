...
const getCustomerTypeData = async (req, res) => {
  const Path = path.join(__dirname, '../Data/CustomerType.json');////connecting from AccountIndustry json file
  try {
...
module.exports = { getCustomerTypeData };
